...
//           $PartyA = $customerPhone; // This is your phone number, 
...
//           # callback url
//           $CallBackURL = "https://shop.renditionproperties.com/includes/payments/M-pesa/callback.php";  
        
        
          
//               // Define M-PESA endpoint URLs
//      $access_token_url = 'https://sandbox.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials';

//         $response=Http::withBasicAuth($consumerKey,$consumerSecret)->get($access_token_url);
...
//         //   $resultCode=$decoded->ResponseCode; 
//         //   $errorCode = $decoded->errorCode;
    

//     // Return the simplified response data
//     return $response->setData($decoded);
// }
