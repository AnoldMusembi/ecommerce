            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-6 left">
                    ...
                    <div class="form-checkout">
                        ...
                        @if (PaymentMethods::getDefaultMethod())
                            <div class="form-group mb-3 @if ($errors->has('mpesa_phone_number')) has-error @endif">
                        ...
                        @endif
                        <div class="form-group mb-3 @if ($errors->has('refferal_code')) has-error @endif">
                            <label for="refferal_code" class="control-label">{{ __('Refferal Code') }}</label>
                            <br>
                            <input type="text" name="refferal_code" id="refferal_code" rows="3"
                                class="form-control"
                                placeholder="{{ __('Enter Refferal Code') }}">{{ old('refferal_code') }}</textarea>
                            {!! Form::error('refferal_code', $errors) !!}
                        </div>
